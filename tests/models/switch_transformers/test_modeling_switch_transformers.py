...
BERT_CASES = [
    [
        ...
        "mindway.transformers.SwitchTransformersEncoderModel",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindway.transformers.SwitchTransformersForConditionalGeneration",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindway.transformers.SwitchTransformersModel",
        (config,),
        {},
        (input_ids,),
        {
