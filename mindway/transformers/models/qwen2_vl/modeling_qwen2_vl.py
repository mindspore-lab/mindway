...
from mindway.transformers.cache_utils import (  # TODO: SlidingWindowCache
    Cache,
    DynamicCache,
    get_max_length,
    get_seq_length,
...
QWEN2VL_START_DOCSTRING = r"""
    This model inherits from [`MSPreTrainedModel`](https://github.com/mindspore-lab/mindway/blob/master/mindway/transformers/modeling_utils.py#L513).
