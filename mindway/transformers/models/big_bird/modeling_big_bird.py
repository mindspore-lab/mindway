...
def load_tf_weights_in_big_bird(model, tf_checkpoint_path, is_trivia_qa=False):
    ...
    for txt_name in names:
        ...
        pointer.data = ms.from_numpy(array)
...
class BigBirdPreTrainedModel(MSPreTrainedModel):
    """
...
BIG_BIRD_START_DOCSTRING = r"""
    This model is a mindspore [mindspore.nn.Cell](https://www.mindspore.cn/docs/zh-CN/master/api_python/nn/mindspore.nn.Cell.html) sub-class. Use
    it as a regular mindspore Cell and refer to the PyTorch documentation for all matter related to general usage and
    behavior.
...
class BigBirdForQuestionAnsweringModelOutput(ModelOutput):
    ...
    Args:
        ...
        pooler_output (`ms.Tensor` of shape `(batch_size, 1)`):
...
class BigBirdForPreTraining(BigBirdPreTrainedModel):
    ...
    def construct(
        ...
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
    ) -> Union[BigBirdForPreTrainingOutput, Tuple[ms.Tensor]]:
        r"""
...
class BigBirdForCausalLM(BigBirdPreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        return_dict: Optional[bool] = None,
        **kwargs,
    ) -> Union[CausalLMOutputWithCrossAttentions, Tuple[ms.Tensor]]:
        r"""
        encoder_hidden_states  (`ms.Tensor` of shape `(batch_size, sequence_length, hidden_size)`, *optional*):
            Sequence of hidden-states at the output of the last layer of the encoder. Used in the cross-attention if
            the model is configured as a decoder.
...
class BigBirdForQuestionAnswering(BigBirdPreTrainedModel):
    ...
    def construct(
        ...
        attention_mask: Optional[ms.Tensor] = None,
        question_lengths: Optional[ms.Tensor] = None,
        token_type_ids: Optional[ms.Tensor] = None,
        position_ids: Optional[ms.Tensor] = None,
        head_mask: Optional[ms.Tensor] = None,
        inputs_embeds: Optional[ms.Tensor] = None,
        ...
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
    ) -> Union[BigBirdForQuestionAnsweringModelOutput, Tuple[ms.Tensor]]:
        r"""
        ...
        ```python
        >>> target_start_index, target_end_index = ms.Tensor([130]), ms.Tensor([132])
