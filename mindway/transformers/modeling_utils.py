...
if is_safetensors_available():
    ...
    # from mindway.safetensors.mindspore import load_file as safe_load_file
    from mindway.safetensors.mindspore import save_file as safe_save_file
        ...
        * `low_cpu_mem_usage` algorithm:
        ...
        if from_pt:
            ...
            if mindspore_dtype is not None:
                config.mindspore = dtype_to_str(mindspore_dtype)
